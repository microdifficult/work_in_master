 ...
 */
FARPROC WINAPI wenjianchuliDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = wenjianchuliDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = wenjianchuliDelayLoadWin32FailureHook;
#endif

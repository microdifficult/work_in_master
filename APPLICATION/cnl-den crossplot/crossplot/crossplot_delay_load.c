 ...
 */
FARPROC WINAPI crossplotDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = crossplotDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = crossplotDelayLoadWin32FailureHook;
#endif

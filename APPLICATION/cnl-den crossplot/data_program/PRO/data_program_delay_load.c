 ...
 */
FARPROC WINAPI data_programDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = data_programDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = data_programDelayLoadWin32FailureHook;
#endif
